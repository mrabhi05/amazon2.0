...
function generateItems(items){
    ...
    items.forEach((item) =>{
        ...
        addToCartEl.classList.add("product-add-to-cart", "h-8", "w-28", "bg-yellow-500", "items-center", "justify-center", "rounded", "flex", "text-md", "text-white", "cursor-pointer", "hover:bg-yellow-600");
