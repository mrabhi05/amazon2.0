    ...
    cartItems.forEach((item) => {
        itemsHTML += `
                        <div class="cart-item flex items-center pb-4">
                            <div class="cart-item-image w-40 h-24 bg-white pb-4 border-b border-gray-100 rounded-lg">
                                <img class="w-full h-full object-contain" src="${item.image}">
                            </div>
                            
                            
                            <div class="cart-item-details flex-grow">
                                <div class="cart-items-title font-bold text-sm text-gray-600">
                                    ${item.name}
                                </div>
...
function createEvenListeners(){
    let decreasedButtons = document.querySelectorAll(".cart-item-decrease")
    let increasedButtons = document.querySelectorAll(".cart-item-increase")
